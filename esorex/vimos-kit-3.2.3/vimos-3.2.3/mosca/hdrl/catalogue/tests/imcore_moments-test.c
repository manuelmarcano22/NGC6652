/* $Id: imcore_moments-test.c,v 1.1 2015/10/15 16:18:25 jim Exp $
 *
...
int main(void) {
    ...
    imcore_moments(&ap,results);
    cpl_test_eq((int)results[0],1);
    cpl_test_rel(results[1],400.0,0.01);
    cpl_test_rel(results[2],400.0,0.01);
