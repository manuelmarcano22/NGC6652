 ...
 * modifies ilist_fringe !! */
    ...
    cpl_mask * this_fmsk;
    cpl_matrix * cur_amplitudes = NULL;
    double bkg_level = 0.;
    double fringe_level = 0.;
    double fringe_amplitude = 1.;
    ...
    for (cpl_size i = 0; i < isize; i++) {
        ...
        this_fmsk = cpl_mask_duplicate(hdrl_image_get_mask(this_himg));
        if (ilist_obj != NULL) {
        ...
        cur_amplitudes = hdrl_mime_fringe_amplitudes(
        ...
        fringe_amplitude = fringe_level - bkg_level;
        if (qctable != NULL) {
                    ...
                    cpl_table ** qctable)
{
    ...
    for (cpl_size i = 0; i < isize; i++) {
        ...
        cur_amplitudes = hdrl_mime_fringe_amplitudes_ls(
                            hdrl_image_get_image_const(this_himg), this_fmsk,
