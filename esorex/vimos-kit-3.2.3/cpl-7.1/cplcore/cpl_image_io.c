                                     ...
                                     double value)
{
    ...
    for (j = (size_t)lly; j <= (size_t)ury; j++) {
        for (i = (size_t)llx; i <= (size_t)urx; i++) {
            /* FIXME: Access pixel buffer directly and clear bad pixels */
            code = cpl_image_set(self, (cpl_size)i, (cpl_size)j, value);
            if (code) break;
        }
        if (code) break;
    }
                           ...
                           cpl_type          type)
{
    ...
    double complex       * pdco;
    const size_t           nxy = (size_t)(cpl_image_get_size_x(self) *
    ...
    switch (type) {
        case CPL_TYPE_FLOAT:
            pfo = (float*)cpl_malloc(nxy * sizeof(*pfo));
            ...
            break;
        case CPL_TYPE_DOUBLE:
            pdo = (double*)cpl_malloc(nxy * sizeof(*pdo));
            ...
            break;
        case CPL_TYPE_INT:
            pio = (int*)cpl_malloc(nxy * sizeof(*pio));
            ...
            break;
        case CPL_TYPE_FLOAT_COMPLEX:
            pfco = (float complex*)cpl_malloc(nxy * sizeof(*pfco));
            ...
            break;
        case CPL_TYPE_DOUBLE_COMPLEX:
            pdco = (double complex*)cpl_malloc(nxy * sizeof(*pdco));
