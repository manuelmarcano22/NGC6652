  ...
  */
  ...
  for (i = 0; i < r; i++) {
      for (j = 0; j < c; j++) {
          ...
          test_fvalue(13.565656565, .000001, cpl_matrix_get(matrix, i, j), 
                      message);
      }
  }
...
*/
  ...
  for (i = 0; i < c; i++) {
      sprintf(message, "Check element %" CPL_SIZE_FORMAT " of copied row... ",
              i);
      test_fvalue(cpl_matrix_get(matrix, 2, i), 0.00001,
                  cpl_matrix_get(copia, 0, i), message);
  }
  ...
  for (i = 0; i < r; i++) {
      ...
      test_fvalue(cpl_matrix_get(matrix, i, 3), 0.00001,
                  cpl_matrix_get(copia, i, 0), message);
  }
  ...
  for (i = 0; i < r; i++) {
      ...
      test_fvalue(cpl_matrix_get(matrix, i, i), 0.00001,
                  cpl_matrix_get(copia, i, 0), message);
  }
  ...
  for (i = 0; i < r; i++) {
      ...
      test_fvalue(cpl_matrix_get(matrix, i , i + 2), 0.00001,
                  cpl_matrix_get(copia, i, 0), message);
  }
  ...
  for (i = 0; i < r; i++) {
      sprintf(message, "Check element %" CPL_SIZE_FORMAT " of written "
              "diagonal... ", i);;
  ...
  for (i = 0; i < c; i++) {
      sprintf(message, "Check element %" CPL_SIZE_FORMAT " of copied diagonal "
              "(vertical)... ", i);
      test_fvalue(cpl_matrix_get(matrix, i, i), 0.00001,
                  cpl_matrix_get(copia, 0, i), message);
  }
  ...
  for (i = 0; i < c; i++) {
      sprintf(message, 
              ...
              "(vertical)... ", i);
      test_fvalue(cpl_matrix_get(matrix, i + 1, i), 0.00001,
                  cpl_matrix_get(copia, 0, i), message);
  }
  ...
  for (i = 0; i < r; i++) {
      sprintf(message, "Check element %" CPL_SIZE_FORMAT ", %" CPL_SIZE_FORMAT
              " of matrix... ", i / c, i % c);
      test_fvalue(3.33, 0.00001, cpl_matrix_get(matrix, i / c, i % c),
                  message);
  }
  ...
  for (i = 0; i < c; i++) {
      sprintf(message, "Check element %" CPL_SIZE_FORMAT " of constant row... ",
              i);
      test_fvalue(2.0, 0.00001, cpl_matrix_get(matrix, 4, i), message);
  }
  ...
  for (i = 0; i < r; i++) {
      ...
      test_fvalue(9.99, 0.00001, cpl_matrix_get(matrix, i, 2), message);
  }
  ...
  for (i = 0; i < c; i++) {
      ...
      test_fvalue(1.11, 0.00001, cpl_matrix_get(matrix, i, i), message);
  }
  ...
  for (i = 0; i < c; i++) {
      ...
      test_fvalue(1.1, 0.00001, cpl_matrix_get(matrix, i + 1, i), message);
  }
  ...
  for (i = 0; i < r; i++) {
      for (j = 0; j < c; j++) {
          ...
          test_fvalue(cpl_matrix_get(matrix, i, j), 0.00001,
                      cpl_matrix_get(copia, i, j), message);
      }
  }
  ...
  for (i = 0; i < r; i++) {
      for (j = 0; j < c; j++) {
          ...
          test_fvalue(cpl_matrix_get(matrix, i, j) - 8., 0.00001,
                      cpl_matrix_get(copia, i, j), message);
      }
  }
  ...
  for (i = 0; i < r; i++) {
      for (j = 0; j < c; j++) {
          ...
          test_fvalue(cpl_matrix_get(copia, i, j), 0.00001,
                      cpl_matrix_get(matrix, i + 2, j + 2), message);
      }
  }
  ...
  for (i = 1; i < 4; i++) {
      for (j = 1; j < 3; j++) {
          ...
          test_fvalue(0.0, 0.00001, cpl_matrix_get(matrix, i, j), message);
      }
  }
      ...
      for (j = 0; j < c; j++) {
          ...
          if (i > 1 && j > 1) {
              test_fvalue(0.0, 0.00001, 
                          cpl_matrix_get(matrix, i, j), message);
          }
          else {
              test_fvalue(cpl_matrix_get(copia, i, j), 0.00001, 
                          cpl_matrix_get(matrix, i, j), message);
  ...
  for (i = 0; i < r; i++) {
      for (j = 0; j < c; j++) {
          ...
          if (i > r - 2) {
              test_fvalue(cpl_matrix_get(copia, i, j), 0.00001,
                          cpl_matrix_get(matrix, i + 1 - r, j), message);
          }
          else {
              test_fvalue(cpl_matrix_get(copia, i, j), 0.00001,
                          cpl_matrix_get(matrix, i + 1, j), message);
          }
      }
  }
  ...
  for (i = 0; i < r; i++) {
      for (j = 0; j < c; j++) {
          ...
          if (j > c - 2) {
              test_fvalue(cpl_matrix_get(copia, i, j), 0.00001,
                          cpl_matrix_get(matrix, i, j + 1 - c), message);
          }
          else {
              test_fvalue(cpl_matrix_get(copia, i, j), 0.00001,
                          cpl_matrix_get(matrix, i, j + 1), message);
          }
      }
  }
  ...
  for (i = 0; i < r; i++) {
      for (j = 0; j < c; j++) {
          ...
          if (j > c - 5 && i > r - 5) {
              ...
              test_fvalue(cpl_matrix_get(copia, i, j), 0.00001,
                          cpl_matrix_get(matrix, i + 4, j + 4 - c), message);
          }
          else if (i > r - 5) {
              test_fvalue(cpl_matrix_get(copia, i, j), 0.00001,
                          cpl_matrix_get(matrix, i + 4 - r, j + 4), message);
          }
          else {
              test_fvalue(cpl_matrix_get(copia, i, j), 0.00001,
                          cpl_matrix_get(matrix, i + 4, j + 4), message);
          }
      }
  }
  ...
  for (j = 0; j < c; j++) {
      sprintf(message, "Check column %" CPL_SIZE_FORMAT
              " of row swapped matrix... ", j);
      test_fvalue(cpl_matrix_get(copia, 1, j), 0.00001,
                  cpl_matrix_get(matrix, 3, j), message);
      test_fvalue(cpl_matrix_get(copia, 3, j), 0.00001,
                  cpl_matrix_get(matrix, 1, j), message);
  }
  ...
  for (i = 0; i < r; i++) {
      sprintf(message, "Check row %" CPL_SIZE_FORMAT
              " of column swapped matrix... ", i);
      test_fvalue(cpl_matrix_get(copia, i, 1), 0.00001,
                  cpl_matrix_get(matrix, i, 3), message);
      test_fvalue(cpl_matrix_get(copia, i, 1), 0.00001,
                  cpl_matrix_get(matrix, i, 3), message);
  }
  ...
  for (i = 0; i < 5; i++) {
      sprintf(message, "Check row/column element %" CPL_SIZE_FORMAT
              " of swapped matrix... ", i);
      test_fvalue(cpl_matrix_get(matrix, i, 1), 0.00001,
                  cpl_matrix_get(copia, 1, i), message);
      test_fvalue(cpl_matrix_get(matrix, i, 1), 0.00001,
                  cpl_matrix_get(copia, 1, i), message);
  }
  ...
  for (i = 0; i < r; i++) {
      for (j = 0; j < c; j++) {
          ...
          test_fvalue(cpl_matrix_get(copia, i, j), 0.00001,
                      cpl_matrix_get(matrix, r - i - 1, j), message);
      }
  }
  ...
  for (i = 0; i < r; i++) {
      for (j = 0; j < c; j++) {
          sprintf(message,
                  ...
                  " of row-flipped matrix... ", i, j);
          test_fvalue(cpl_matrix_get(copia, i, j), 0.00001,
                      cpl_matrix_get(matrix, r - i - 1, c - j - 1), message);
      }
  }
  ...
  for (i = 0; i < r; i++) {
      for (j = 0; j < c; j++) {
          ...
          test_fvalue(cpl_matrix_get(matrix, i, j), 0.00001,
                      cpl_matrix_get(copia, j, i), message);
      }
  }
  ...
  for (i = 0; i < r; i++) {
      ...
      for (j = 0; j < c; j++) {
          ...
          test_fvalue(cpl_matrix_get(copia, i, j), 0.00001,
                      cpl_matrix_get(matrix, k, j), message);
      }
      k++;
  }
  ...
  for (i = 2; i < r - 2; i++) {
      for (j = 2; j < c - 2; j++) {
          ...
          test_fvalue(cpl_matrix_get(matrix, i - 2, j - 2), 0.00001,
                      cpl_matrix_get(copia, i, j), message);
      }
  }
  ...
  for (i = 0; i < r; i++) {
      for (j = 0; j < c; j++) {
          sprintf(message,
                  ...
                  i, j + 1);
          test_fvalue(cpl_matrix_get(matrix, i, j), 0.00001,
                      cpl_matrix_get(copia, i, j + 1), message);
      }
  }
  ...
  for (i = 0; i < r; i++) {
      sprintf(message, 
              ...
              " of horizontally merged matrix... ",
              i, 0);
      test_fvalue(cpl_matrix_get(product, i, 0), 0.00001,
                  cpl_matrix_get(copia, i, 0), message);
  }
  ...
  for (i = 0; i < 4; i++) {
      for (j = 0; j < c; j++) {
          sprintf(message,
                  ...
                  i, j);
          test_fvalue(cpl_matrix_get(product, i, j), 0.00001,
                      cpl_matrix_get(copia, i, j), message);
      }
  }
  ...
  for (i = 0; i < r; i++) {
      for (j = 0; j < c; j++) {
          sprintf(message,
                  ...
                  i + 4, j);
          test_fvalue(cpl_matrix_get(matrix, i, j), 0.00001,
                      cpl_matrix_get(copia, i + 4, j), message);
      }
  }
  ...
  for (i = 0; i < r; i++) {
      for (j = 0; j < c; j++) {
          ...
          test_fvalue(cpl_matrix_get(matrix, i, j) * 2, 0.00001,
                      cpl_matrix_get(copia, i, j), message);
      }
  }
  ...
  for (i = 0; i < r; i++) {
      for (j = 0; j < c; j++) {
          ...
          test_fvalue(cpl_matrix_get(matrix, i, j) * 
  ...
  for (i = 0, k = 0; i < 3; i++) {
      for (j = 0; j < 4; j++) {
          k++;
          sprintf(message, "Writing to element %" CPL_SIZE_FORMAT
                  " of the first matrix... ", k);
          test(cpl_matrix_set(matrix, i, j, value), message);
          value++;
      }
  }
  ...
  for (i = 0, k = 0; i < 4; i++) {
      for (j = 0; j < 5; j++) {
          ...
          test(cpl_matrix_set(copia, i, j, value), message);
          value++;
      }
  }
